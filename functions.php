...
if ( ! function_exists( 'skeleto_setup' ) ) :
	...
	function skeleto_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'skeleto' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'skeleto_custom_background_args', array(
...
function skeleto_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'skeleto_content_width', 640 );
}
...
function skeleto_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'skeleto' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'skeleto' ),
...
add_action( 'wp_enqueue_scripts', 'skeleto_scripts' );
